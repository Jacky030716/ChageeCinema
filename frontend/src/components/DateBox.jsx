...
const DateBox = ({date, selected}) => {
  return (
    <div className={`${date === selected ? 'bg-yellow-300 border-yellow-300 border-none': ''}border-white border-2 shadow-neutral-300 rounded-md w-fit px-4 py-2 flex flex-col items-center cursor-pointer  hover:bg-yellow-300 hover:border-yellow-300 group`}>
